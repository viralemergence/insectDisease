...
negative <- read.csv(file='csv/negative.csv')
nematode <- read.csv(file='csv/nematode.csv')
nvpassoc <- read.csv(file='csv/nvpassoc.csv')
viruses <- read.csv(file='csv/viruses.csv')
